...
EPG_main = pd.read_excel(r'E:\python codes\weekly reports\total_EPG.xlsx')
...
EPG_sima_1 = EPG_sima.copy()
EPG_sima_2 = EPG_sima.copy()
EPG_sima_new = EPG_sima_1.groupby(['channel', 'program']).sum().reset_index()
EPG_sima_new2 = EPG_sima_2.groupby(['channel', 'program', 'Date']).sum().reset_index()
EPG_radio = EPG_Repeat.query('Service == "رادیویی"')
EPG_radio_1 = EPG_radio.copy()
EPG_radio_2 = EPG_radio.copy()
EPG_radio_new = EPG_radio_1.groupby(['channel', 'program']).sum().reset_index()
EPG_radio_new2 = EPG_radio_2.groupby(['channel', 'program', 'Date']).sum().reset_index()
EPG_ostani = EPG_Repeat.query('Service == "استانی"')
EPG_ostani_1 = EPG_ostani.copy()
EPG_ostani_2 = EPG_ostani.copy()
EPG_ostani_new = EPG_ostani_1.groupby(['channel', 'program']).sum().reset_index()
EPG_ostani_new2 = EPG_ostani_2.groupby(['channel', 'program', 'Date']).sum().reset_index()
EPG_ekhtesasi = EPG_Repeat.query('Service == "اختصاصی"')
EPG_ekhtesasi_1 = EPG_ekhtesasi.copy()
EPG_ekhtesasi_2 = EPG_ekhtesasi.copy()
EPG_ekhtesasi_new = EPG_ekhtesasi_1.groupby(['channel', 'program']).sum().reset_index()
EPG_ekhtesasi_new2 = EPG_ekhtesasi_2.groupby(['channel', 'program', 'Date']).sum().reset_index()
EPG_boronmarzi = EPG_Repeat.query('Service == "برون مرزی"')
EPG_boronmarzi_1 = EPG_boronmarzi.copy()
EPG_boronmarzi_2 = EPG_boronmarzi.copy()
EPG_boronmarzi_new = EPG_boronmarzi_1.groupby(['channel', 'program']).sum().reset_index()
EPG_boronmarzi_new2 = EPG_boronmarzi_2.groupby(['channel', 'program', 'Date']).sum().reset_index()

EPG_movie = EPG_sima.query('Type == "فیلم سینمایی"')
EPG_news = EPG_sima.query('Type == "اخبار"')
EPG_news_1 = EPG_news.copy()
EPG_news_2 = EPG_news.copy()
EPG_news_new = EPG_news_1.groupby(['channel', 'program']).sum().reset_index()
EPG_news_new2 = EPG_news_2.groupby(['channel', 'program', 'Date']).sum().reset_index()
EPG_series = EPG_sima.query('Type == "مجموعه تلویزیونی"')
EPG_series_1 = EPG_series.copy()
EPG_series_2 = EPG_series.copy()
EPG_series_new = EPG_series_1.groupby(['channel', 'program']).sum().reset_index()
EPG_series_new2 = EPG_series_2.groupby(['channel', 'program', 'Date']).sum().reset_index()
EPG_sport = EPG_sima.query('Type == "ورزشی"')
EPG_sport_1 = EPG_sport.copy()
EPG_sport_2 = EPG_sport.copy()
EPG_sport_new = EPG_sport_1.groupby(['channel', 'program']).sum().reset_index()
EPG_sport_new2 = EPG_sport_2.groupby(['channel', 'program', 'Date']).sum().reset_index()
EPG_kid = EPG_sima.query('Type == "کودک"')
EPG_kid_1 = EPG_kid.copy()
EPG_kid_2 = EPG_kid.copy()
EPG_kid_new = EPG_kid_1.groupby(['channel', 'program']).sum().reset_index()
EPG_kid_new2 = EPG_kid_2.groupby(['channel', 'program', 'Date']).sum().reset_index()
...
###### radio ######
## Visit ##
EPG_radio_new.sort_values('Visit', axis = 0, ascending = False, inplace = True, na_position ='last')
EPG_radio_new = EPG_radio_new.reset_index()
del EPG_radio_new['index']
EPG_radio_visit = EPG_radio_new.loc[0:4, :]
del EPG_radio_visit['Duration']
## Duration ##
EPG_radio_new.sort_values('Duration', axis = 0, ascending = False, inplace = True, na_position ='last')
EPG_radio_new = EPG_radio_new.reset_index()
del EPG_radio_new['index']
EPG_radio_duration= EPG_radio_new.loc[0:4, :]
del EPG_radio_duration['Visit']
###### ostani ######
## Visit ##
EPG_ostani_new.sort_values('Visit', axis = 0, ascending = False, inplace = True, na_position ='last')
EPG_ostani_new = EPG_ostani_new.reset_index()
del EPG_ostani_new['index']
EPG_ostani_visit = EPG_ostani_new.loc[0:4, :]
del EPG_ostani_visit['Duration']
## Duration ##
EPG_ostani_new.sort_values('Duration', axis = 0, ascending = False, inplace = True, na_position ='last')
EPG_ostani_new = EPG_ostani_new.reset_index()
del EPG_ostani_new['index']
EPG_ostani_duration= EPG_ostani_new.loc[0:4, :]
del EPG_ostani_duration['Visit']
###### ekhtesasi ######
## Visit ##
EPG_ekhtesasi_new.sort_values('Visit', axis = 0, ascending = False, inplace = True, na_position ='last')
EPG_ekhtesasi_new = EPG_ekhtesasi_new.reset_index()
del EPG_ekhtesasi_new['index']
EPG_ekhtesasi_visit = EPG_ekhtesasi_new.loc[0:4, :]
del EPG_ekhtesasi_visit['Duration']
## Duration ##
EPG_ekhtesasi_new.sort_values('Duration', axis = 0, ascending = False, inplace = True, na_position ='last')
EPG_ekhtesasi_new = EPG_ekhtesasi_new.reset_index()
del EPG_ekhtesasi_new['index']
EPG_ekhtesasi_duration= EPG_ekhtesasi_new.loc[0:4, :]
del EPG_ekhtesasi_duration['Visit']
###### boronmarzi ######
## Visit ##
EPG_boronmarzi_new.sort_values('Visit', axis = 0, ascending = False, inplace = True, na_position ='last')
EPG_boronmarzi_new = EPG_boronmarzi_new.reset_index()
del EPG_boronmarzi_new['index']
EPG_boronmarzi_visit = EPG_boronmarzi_new.loc[0:4, :]
del EPG_boronmarzi_visit['Duration']
## Duration ##
EPG_boronmarzi_new.sort_values('Duration', axis = 0, ascending = False, inplace = True, na_position ='last')
EPG_boronmarzi_new = EPG_boronmarzi_new.reset_index()
del EPG_boronmarzi_new['index']
EPG_boronmarzi_duration= EPG_boronmarzi_new.loc[0:4, :]
...
###### series ######
## Visit ##
EPG_series_dup = EPG_series.copy()
EPG_series_dup = EPG_series_dup.groupby(['channel', 'program']).sum().reset_index()
EPG_series_dup.sort_values('Visit', axis = 0, ascending = False, inplace = True, na_position ='last')
EPG_series_dup = EPG_series_dup.reset_index()
del EPG_series_dup['index']
EPG_series_visit = EPG_series_dup.loc[0:10, :]
...
EPG_series_dup = EPG_series.copy()
EPG_series_dup = EPG_series_dup.groupby(['channel', 'program']).sum().reset_index()
EPG_series_dup.sort_values('Duration', axis = 0, ascending = False, inplace = True, na_position ='last')
EPG_series_dup = EPG_series_dup.reset_index()
del EPG_series_dup['index']
EPG_series_duration= EPG_series_dup.loc[0:10, :]
...
[EPG_S_sima_visit, EPG_S_sima_duration, EPG_S_radio_visit, EPG_S_radio_duration, 
                                 ...
                                 EPG_news_2, EPG_series_2, EPG_sport_2, \
                                 EPG_kid_2, EPG_documentary)
######################################################
